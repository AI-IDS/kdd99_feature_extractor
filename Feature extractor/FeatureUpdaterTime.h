...
namespace FeatureExtractor {
	class FeatureUpdaterTime : public FeatureUpdater
	{
	public:
		...
		virtual void set_srv_diff_host_rate(ConversationFeatures * f, double srv_diff_host_rate);
		virtual void set_dst_host_same_src_port_rate(ConversationFeatures * f, double dst_host_same_src_port_rate);
		virtual void set_same_srv_count(ConversationFeatures * f, double same_srv_count) = 0;
	};
}
